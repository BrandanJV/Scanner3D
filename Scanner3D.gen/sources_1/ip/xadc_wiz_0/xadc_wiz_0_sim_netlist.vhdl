...
-- Command     : write_vhdl -force -mode funcsim {c:/Users/jimen/Documents/Tec/6to Semestre/Lab de
--               Sistemas/Scanner3D/Scanner3D.gen/sources_1/ip/xadc_wiz_0/xadc_wiz_0_sim_netlist.vhdl}
-- Design      : xadc_wiz_0
...
U0: unisim.vcomponents.XADC
    generic map(
      ...
      VAUXN(10) => vauxn10,
      VAUXN(9 downto 0) => B"0000000000",
      VAUXP(15 downto 11) => B"00000",
      VAUXP(10) => vauxp10,
      VAUXP(9 downto 0) => B"0000000000",
      VN => vn_in,
      VP => vp_in
    );
end STRUCTURE;
